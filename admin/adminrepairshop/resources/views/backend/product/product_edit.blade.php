...
<div class="card">
  <div class="card-body p-4">
	  <h5 class="card-title">Edith Product</h5>
	  <hr>
...
<div class="form-check">
	 <input class="form-check-input" name="remark" type="checkbox" value="FEATURED" id="flexCheckDefault1"
	 ...
	 <div class="form-check">
	 <input class="form-check-input" name="remark" type="checkbox" value="NEW" id="flexCheckDefault2"
	 ...
	 <div class="form-check">
	 <input class="form-check-input" name="remark" type="checkbox" value="COLLECTION" id="flexCheckDefault3"
