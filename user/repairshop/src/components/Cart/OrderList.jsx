...
export class OrderList extends Component {
     ...
     PostReview = () => {
          ...
          if (name.length === 0) {
               ...
               MyFromData.append('reviewer_photo', "asd.png ")
               ...
               axios.post(AppURL.PostReview, MyFromData).then(response => {
                    ...
                    cogoToast.error("Something is wrong", { position: 'top-right' });
          ...
          const MyView = MyList.map((ProductList, i) => {
               return <div>
                    <Col md={6} lg={6} sm={6} xs={6}>
                         ...
                         <h6>Price = {ProductList.unit_price} x {ProductList.quantity} = 
                         {ProductList.total_price}$</h6>
