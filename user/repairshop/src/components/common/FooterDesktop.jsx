   ...
   <Fragment>
    <div className='footerback m-0 mt-3 p-3 shadow-sm'>    
     ...
     <div className={this.state.loaderDiv}>
        ...
        <a href={this.state.facebook_link} target="blank"><i className='fab m-1 h4 fa-facebook'></i></a>
        ...
        <a href={this.state.android_app_link} target='_blank'><img src={Google}  /></a><br />
        <a href={this.state.ios_app_link} target='_blank'><img className='mt-2' src={Apple}  /></a><br />
        Change you`r lenguage <br />
