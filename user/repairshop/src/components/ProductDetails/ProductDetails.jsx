...
class ProductDetails extends Component {
   ...
   PageRedirect =() => {
    ...
    render() {
        ...
        let category = ProductAllData['productList'][0]['category_id'];
        let subcategory = ProductAllData['productList'][0]['subcategory_id'];
                        ...
                        <Col className="shadow-sm bg-white pb-3 mt-4" md={12} lg={12} sm={12} xs={12}>
                            <Row>
                                <Col className="p-3" md={6} lg={6} sm={12} xs={12}>
                                    ...
                                    <InnerImageZoom className="detailimage" zoomScale={1.8} zoomType={"hover"} src={this.state.previewImg}
